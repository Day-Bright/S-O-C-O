...
public class soco_index_bet {

    public static ArrayList<ArrayList<String>> csv() throws Exception{

        File csv = new File("C:\\Users\\管理员\\Documents\\Tencent Files\\1520207872\\FileRecv\\新建文件夹\\AI-SOCO-master\\data_dir\\train.csv"); // CSV文件路径
...
//            System.out.println(mapKey+":"+mapValue);
            ...
            for(String pid :mapValue){
                String Path = "C:\\Users\\管理员\\Documents\\Tencent Files\\1520207872\\FileRecv\\新建文件夹\\AI-SOCO-master\\data_dir\\train\\"+pid;
//                System.out.println();
