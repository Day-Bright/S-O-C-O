...
//                map.add(x);
    ...
    public static void BuildIndex(HashMap<String, String> csv) throws Exception {
        ...
        String creat_path = "C:\\Users\\管理员\\Desktop\\have_num_23456gram";
...
//                    System.out.println(writter);
                    document.add(new Field("content",s1,type1));
                    document.add(new Field("uid",writter,type1));
